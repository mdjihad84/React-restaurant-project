...
const Hero = () => {
  return (
    <div className="block">
      <div>
        <img
          className="w-full h-[300px] sm:h-[300px] md:h-[500px] lg:h-[700px] xl:h-[804px] object-cover"
          src="/Images/Hero3.jpg" alt="Hero image"/>
        <div className="w-[90%] md:w-[1096px] h-[300px] bg-black mx-auto absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex items-center z-40 opacity-90 justify-center">
          <div className="w-[90%] md:w-[740px] text-center">
            <h2 className="text-white mt-4 font-enter text-[32px] sm:text-[56px] md:text-[88px]">OUR SHOP</h2>
      ...
      <div className="mt-20">
        <p className="text-center text-xl font-normal italic text-[#D99904]">---Should Try---</p>
        ...
        {[1, 2, 3].map((_, rowIndex) => (
          <div key={rowIndex} className="flex flex-col md:flex-row justify-center items-center gap-10 mt-8">
            {["Slide1.jpg", "Slide1.jpg", "Slide1.jpg"].map((imgSrc, index) => (
              <div key={index} className="card w-full max-w-[350px] h-[541px] bg-[#F3F3F3] flex-shrink-0">
                <div>
