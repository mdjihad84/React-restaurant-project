    ...
    return (
        <div>
            <div className="mx-auto mt-20 relative mb-20">
                <img src="/Images/LoginPage-bg.png" className="w-full h-[1146px] object-cover" alt="Latest News" />
                <div>
                    ...
                    <div className="w-[90%] md:w-[1140px] h-auto shadow-xl absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col md:flex-row items-center justify-center">
                        ...
                        <div className="flex items-center justify-center min-h-screen">
                            <div className="w-full max-w-md p-6 rounded-lg">
                                ...
                                <form className="mt-6">
                                    ...
                                    <div className="mb-6">
                                        <input type="text" id="text1" className="bg-white w-full p-3 mt-1 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-500" placeholder="U A g l u o" required />
                                    </div>
                                    <div className="mb-6">
                                        <input type="text" id="text2" className="bg-white w-full p-3 mt-1 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-500" placeholder="Type here" required />
                                    </div>
